# 【功能描述】LLM 文案润色器：原始草稿 → 反常识理性冷幽默文稿
# 【输入】RawInput；TextLLM；polish 提示词模板
# 【输出】润色后的 Markdown 文本
...
_PROMPT = (Path(__file__).parent.parent / "prompts" / "polish.txt").read_text(encoding="utf-8")


class LlmCopyPolisher:
